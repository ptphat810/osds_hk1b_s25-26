...
# 4.3 Tìm tất cả video của người dùng có username là "user1"
...
# 5. Cập nhật dữ liệu
# 5.1 Cập nhật số người theo dõi của người dùng với `user_id` là 1 lên 2000
users_collection.update_one({'user_id': 1}, {'$set': {'followers': 2000}})

# 5.2 Xóa video có `video_id` là 3
videos_collection.delete_one({'video_id': 3})

# 6. Xem lại dữ liệu sau khi cập nhật
